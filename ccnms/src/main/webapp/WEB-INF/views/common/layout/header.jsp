						...
						<div class="header__top__right__auth">
							<c:choose>
								<c:when test="${sessionScope.role eq 'admin'}">
									<div class="header__top__right__auth">
										<p>
											<a href="${contextPath }/admin/digging/diggingAdd"><button
													type="button" class="btn btn-secondary disabled">디깅하기</button></a>
										</p>
									</div>
									<div class="header__top__right__auth">
										<p>
											<a href="${contextPath }/admin/main"><button
													type="button" class="btn btn-outline-dark">관리자 페이지</button></a>
										</p>
									</div>
									<div class="header__top__right__language">
										<p>
			...
			<div class="col-lg-6">
				<nav class="header__menu">
					<ul style="">
						...
						<li><a href="${contextPath }/digging/main?diggingTopic=kPop"><img
								alt="상점에러"
								src="${contextPath }/resources/bootstrap/img/shop.png"> 디깅
						</a>
							<ul class="header__menu__dropdown">
								<li><a
									href="${contextPath }/digging/main?diggingTopic=kPop"><img
										alt="케이팝에러"
										src="${contextPath }/resources/bootstrap/img/icon/kPop.png"><strong>&emsp;K-POP</strong></a></li>
								<li><a
									href="${contextPath }/digging/main?diggingTopic=game"><img
										alt="게임에러"
										src="${contextPath }/resources/bootstrap/img/icon/game.png"><strong>&emsp;게임</strong></a></li>
								<li><a href="${contextPath }/digging/main?diggingTopic=ott"><img
										alt="오티티에러"
										src="${contextPath }/resources/bootstrap/img/icon/ott.png"><strong>&emsp;OTT</strong></a></li>
								<li><a
									href="${contextPath }/digging/main?diggingTopic=animal"><img
										alt="펫에러"
										src="${contextPath }/resources/bootstrap/img/icon/animal.png"><strong>&emsp;동물&애완동물</strong></a></li>
								<li><a
									href="${contextPath }/digging/main?diggingTopic=business"><img
										alt="비즈니스에러"
										src="${contextPath }/resources/bootstrap/img/icon/business.png"><strong>&emsp;비즈니스</strong></a></li>
								<li><a
									href="${contextPath }/digging/main?diggingTopic=sport"><img
										alt="스포츠에러"
										src="${contextPath }/resources/bootstrap/img/icon/sport.png"><strong>&emsp;스포츠</strong></a></li>
								<li><a
									href="${contextPath }/digging/main?diggingTopic=celeb"><img
										alt="연예인에러"
										src="${contextPath }/resources/bootstrap/img/icon/celeb.png"><strong>&emsp;연예인</strong></a></li>
								<li><a
									href="${contextPath }/digging/main?diggingTopic=travel"><img
										alt="여행에러"
										src="${contextPath }/resources/bootstrap/img/icon/travel.png"><strong>&emsp;여행</strong></a></li>
								<li><a
									href="${contextPath }/digging/main?diggingTopic=fashion"><img
										alt="패션에러"
										src="${contextPath }/resources/bootstrap/img/icon/fashion.png"><strong>&emsp;패션</strong></a></li>
							</ul></li>

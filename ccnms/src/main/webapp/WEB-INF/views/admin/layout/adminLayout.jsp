...
<html
  ...
  data-assets-path="${contextPath}/resources/admin/assets/"
...
>
  ...
  <body>
    ...
    <script src="${contextPath}/resources/admin/assets/vendor/libs/popper/popper.js"></script>
    <script src="${contextPath}/resources/admin/assets/vendor/js/bootstrap.js"></script>
    ...
    <!-- Page JS -->
    <script src="${contextPath}/resources/admin/assets/js/dashboards-analytics.js"></script>
